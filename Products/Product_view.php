...
<html lang="en">
  ...
  <body>
    <main class="flex-grow container mx-auto px-4 py-8">
      <div class="flex flex-col md:flex-row">
        ...
        <div class="md:w-1/2 flex flex-col items-center">
          <div class="big-img mb-4">
            <img id="bigImg" src="<?php echo htmlspecialchars($product['Product_image_path']); ?>" alt="<?php echo htmlspecialchars($product['Product_name']); ?>" class="rounded-lg shadow-lg max-w-full h-auto" />
          </div>
        </div>

        <!-- Product Details -->
        <div class="md:w-1/2 md:ml-8 mt-8 md:mt-0">
          <div class="pname text-3xl font-bold mb-2"><?php echo htmlspecialchars($product['Product_name']); ?></div>
          ...
          <div class="size mb-4">
            <p class="text-gray-700 font-semibold">Size :</p>
            <div class="flex space-x-2 mt-1">
              <div class="psize active bg-gray-200 text-gray-700 px-3 py-1 rounded cursor-pointer">M</div>
              <div class="psize bg-gray-200 text-gray-700 px-3 py-1 rounded cursor-pointer">L</div>
              <div class="psize bg-gray-200 text-gray-700 px-3 py-1 rounded cursor-pointer">XL</div>
              <div class="psize bg-gray-200 text-gray-700 px-3 py-1 rounded cursor-pointer">XXL</div>
            </div>
          </div>
          ...
          <div class="btn-box flex space-x-4">
            <button class="wishlist-btn bg-gradient-to-r from-orange-500 to-red-500 text-white px-6 py-2 rounded-lg hover:from-red-500 hover:to-orange-500 transition duration-300 flex items-center space-x-2 shadow-md">
      ...
      <div class="description border border-gray-200 rounded-lg p-6 mt-10 shadow-sm">
        <h6 class="text-lg font-bold mb-4">Product Description</h6>
        <p class="text-gray-700 leading-relaxed"><?php echo nl2br(htmlspecialchars($product['Product_Description'])); ?></p>
      </div>

      <!-- Customer Reviews Section -->
      <div class="customer-reviews border-t border-gray-200 mt-12 pt-8">
