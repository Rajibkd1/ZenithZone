...
<button onclick="showSection('second')" class="w-full text-left p-4 mb-4 bg-gradient-to-r from-green-400 to-green-500 hover:from-yellow-700 hover:to-yellow-800 rounded-lg shadow-md transition-all duration-200 transform hover:scale-105 flex items-center">
    <i class="fas fa-tags mr-3"></i> Second Hand Product
</button>
<button onclick="showSection('art')" class="w-full text-left p-4 mb-4 bg-gradient-to-r from-orange-400 to-green-500 hover:from-yellow-700 hover:to-yellow-800 rounded-lg shadow-md transition-all duration-200 transform hover:scale-105 flex items-center">
    <i class="fas fa-tachometer-alt mr-3"></i> Art Bidding
</button>
<button onclick="showSection('comission')" class="w-full text-left p-4 mb-4 bg-gradient-to-r from-purple-600 to-purple-700 hover:from-yellow-700 hover:to-yellow-800 rounded-lg shadow-md transition-all duration-200 transform hover:scale-105 flex items-center">
    <i class="fas fa-cogs mr-3"></i> Process Commission
</button>
<button onclick="showSection('order')" class="w-full text-left p-4 mb-4 bg-gradient-to-r from-green-600 to-green-700 hover:from-yellow-700 hover:to-yellow-800 rounded-lg shadow-md transition-all duration-200 transform hover:scale-105 flex items-center">
    <i class="fas fa-cogs mr-3"></i> Order Manage
</button>
